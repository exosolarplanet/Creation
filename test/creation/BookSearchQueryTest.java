...
public class BookSearchQueryTest {
  ...
  public void searchesForBooksInLibraryCatalogueByAuthorSurname() {
    ...
    List<Book> books = new BookSearchQueryBuilder().withSurname("dickens").build().execute();
  ...
  public void searchesForBooksInLibraryCatalogueWithCombinationOfParameters() {
    ...
    List<Book> books = new BookSearchQueryBuilder().withSurname("dickens").publishedBefore(1840).build().execute();
